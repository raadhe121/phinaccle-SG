...
import { ColorValue, PermissionsAndroid, Platform, Text, TouchableHighlight, TouchableOpacity } from "react-native";
...
export default function Button(props: { onPress: () => void; title: string; color?: ColorValue }) {
  ...
  return (
    <TouchableHighlight underlayColor={colors.underlay} style={{ ...styles.button, backgroundColor: color }} onPress={onPress}>
